...
const repository = require("../repositories/CategoriaSessaoRepository");
const logger = require("../config/logger");
const HttpStatus = require("../utils/httpStatus");

class CategoriaSessaoController extends BaseController {

    constructor() {
        super(repository, "categoria de sessão", {
            entityNamePlural: "categorias de sessão",
...
module.exports = new CategoriaSessaoController();
