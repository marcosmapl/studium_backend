...
const repository = require("../repositories/SituacaoRevisaoRepository");
const logger = require("../config/logger");
const HttpStatus = require("../utils/httpStatus");

class SituacaoRevisaoController extends BaseController {

    constructor() {
        super(repository, "situação de revisão", {
            entityNamePlural: "situações de revisão",
...
module.exports = new SituacaoRevisaoController();
