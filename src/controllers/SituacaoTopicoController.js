...
const repository = require("../repositories/SituacaoTopicoRepository");
const logger = require("../config/logger");
const HttpStatus = require("../utils/httpStatus");

class SituacaoTopicoController extends BaseController {

    constructor() {
        super(repository, "situação de tópico", {
            entityNamePlural: "situações de tópico",
    ...
    /**
     * Busca situação de tópico por descrição
     */
...
module.exports = new SituacaoTopicoController();
