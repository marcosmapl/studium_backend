 ...
 *         description: Erro interno do servidor
 */
router.post("/", verifyToken, cidadeController.createCidade);
router.get("/", verifyToken, cidadeController.findAllCidades);

/**
 * @swagger
 * /api/cidade/nome/{nome}:
 *   get:
 *     summary: Busca cidades por nome (busca parcial)
 *     tags: [Cidade]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *         schema:
 *           type: string
 *         description: Nome da cidade (busca parcial)
 *         example: "Brasília"
 *     responses:
 *       200:
 ...
 *         description: Erro interno do servidor
 */
router.get("/nome/:nome", verifyToken, cidadeController.findCidadeByNome);
...
router.get(
  ...
  verifyToken,
  cidadeController.findCidadesByUnidadeFederativa
);
 ...
 *         description: Cidade não encontrada
 *       409:
 *         description: Nome da cidade já cadastrado
 *       401:
 *         description: Não autorizado
 *       500:
 *         description: Erro interno do servidor
 ...
 *         description: Erro interno do servidor
 */
router.get("/:id", verifyToken, cidadeController.findCidadeById);
router.put("/:id", verifyToken, cidadeController.updateCidade);
router.delete("/:id", verifyToken, cidadeController.deleteCidade);
